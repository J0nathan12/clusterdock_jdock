...
clusterdock_run() {
  ...
  if [ -z "${CLUSTERDOCK_IMAGE}" ]; then
    local CONSTANTS_CONFIG_URL='https://raw.githubusercontent.com/J0nathan12/clusterdock_jdock/master/clusterdock/constants.cfg'
...
clusterdock_ssh() {
  ...
  if [ -z "${CLUSTERDOCK_IMAGE}" ]; then
    local CONSTANTS_CONFIG_URL='https://raw.githubusercontent.com/J0nathan12/clusterdock_centos_7/master/clusterdock/constants.cfg'
